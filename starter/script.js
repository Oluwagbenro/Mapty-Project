...
class App {
    ...
    _newWorkout (e) {
        ...
        //If workout running, cvreate running object
        if(type === 'running'){
...
const app = new App();
// app.reset() //this should be done in the console in other not to loose all the data items.



// const ava = ((new Date() + '').slice(-10));
// console.log(ava);
